          ...
          (when logged-in?
            #?(:cljs
               (comp/fragment
                ...
                (ui-dropdown {:className "item" :text "Project"}
                             (ui-dropdown-menu {}
                                               (ui-dropdown-item {:onClick (fn [] (rroute/route-to! this ProjectReport {}))} "View All")
                                               (ui-dropdown-item {:onClick (fn [] (form/create! this ProjectForm))} "New")))
